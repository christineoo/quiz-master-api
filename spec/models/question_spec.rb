...
RSpec.describe Api::V1::QuestionsController, :type => :model do
  ...
  describe "check_answer?" do
    it 'return true if answer is correct' do
      question = FactoryGirl.create(:question, content: "What is result of 2+2?", answer: '4' )
    ...
    it 'should detect number and words as a correct answer' do
      question = FactoryGirl.create(:question, content: "What is result of 2+2?", answer: 'four' )
      expect(question.check_answer?('4')).to eq(true)
    end

    it 'should ignore whitespaces from answer' do
      question = FactoryGirl.create(:question, content: "What is result of 2+2?", answer: '  This is    4    ' )
